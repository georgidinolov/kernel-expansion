...
\begin{equation}
  \frac{\partial}{\partial t} p(x,y,t) = \mathcal{L}p(x,y,t),\quad (x,y) \in (0,1) \times (0,1) := \Omega.
\end{equation}
...
\end{align}
with the differential operator $\mathcal{L}$ takes the form
\[
...
imposing a computational burden comparable to or better than that of
