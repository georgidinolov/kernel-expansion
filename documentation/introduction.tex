...
To illustrate the working of our Galerkin approximation, we sample
from the repeated sampling distributions of the MLE $\hat{\theta}$. To
do so, we sample from the data-generating stochastic process using
forward Euler, keeping track of the obtained discrete-time extrema. We
thus generate 500 data sets, each consisting of 128 data points. We
then find the MLE $\hat{\theta}$ for each data set. The collection of
estimators are 
