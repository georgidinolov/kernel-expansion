...
Next we present results from a simulation study. Data was generated
from the model with zero drift via forward Euler discretization where
the obtained discrete-time extrema were recorded and used as the
realized extrema. There were 500 data sets, each comprised of 128 data
points. For each dataset, the MLE was found, and thereby approximating
the repeated-sampling distribution for the estimator. Results were
compared to the RSD of the MLE based on the usual bivariate normal
likelihood which disregards the boundaries.
