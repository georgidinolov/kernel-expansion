...
\[
  e^{(k)}(t) = p(\tilde{x},\tilde{y},\tilde{t}) - p^{(k)}(\tilde{x},\tilde{y},\tilde{t}),
\]
as well as the norm
\[
...
$w \in L_2(\tilde{\Omega})$ with $\|w\|_2 < \infty$ are also in
$W_2^2(\tilde{\Omega})$. Finally, if we have the condition (corresponding to
...
to $q(\tilde{x},\tilde{y},\tilde{t})$, the strong solution to the governing Fokker-Planck
...
\begin{lemma}
  ...
  $m \to \infty$: \[ \hat{\theta}_{n,k} \to \theta \].
\end{lemma}
\begin{proof}
