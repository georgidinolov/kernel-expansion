...
\begin{appendices}
  ...
  \begin{align*}
    ...
    \phi(x|\mu_l, \sigma^2_l) &= \frac{1}{\sqrt{2\pi \sigma^2_k}} \cdot
                              ...
                              &:= C(\mu_k, \sigma_k^2; \mu_l, \sigma^2_l)
                                ...
                                \frac{1}{\sigma^2_l} \right)^{-1}
                                \right. \right) \\
    C(\mu_k, \sigma_k^2; \mu_l, \sigma^2_l) &:= \frac{1}
                                              {\sqrt{4\pi^2\sigma^2_k\sigma^2_l}} \cdot
                                              %%% 
                                              \exp\left\{
                                              -\frac{1}{2}\left(
                                              \frac{\mu_k^2}{\sigma_k^2} +
  ...
  \begin{align*}
    ...
    \int_\Omega \tilde{\psi}_k(x)^2 dx &= \displaystyle
                      ...
                      &= \displaystyle
                        \int_\Omega (x-a)^2(b-x)^2
                        C(\mu_k, \sigma_k^2;\mu_k, \sigma_k^2)
                        \phi(x|\mu_k, \sigma_k^2/2)
                        \,dx\\
                      &= C(\mu_k, \sigma_k^2;\mu_k, \sigma_k^2)\displaystyle
                        \int_\Omega (x^2-2ax+a^2)(b^2 - 2xb + x^2)
                        \phi(x|\mu_k, \sigma_k^2/2)
                        \,dx\\
                      &= C(\mu_k, \sigma_k^2;\mu_k, \sigma_k^2)
                        \displaystyle \int_\Omega
                        (x^4 - x^3(2b+2a) + x^2(a^2+b^2+4ab) -
                        x(2ab^2 + 2ba^2) + a^2b^2)
                        \phi(x|\mu_k, \sigma_k^2/2)\,dx \\
                      &= C(\mu_k, \sigma_k^2;\mu_k, \sigma_k^2)
                        \left(M_4 - M_3(2b+2a) +
                        M_2(a^2+b^2+4ab) - M_1(2ab^2 + 2ba^2) +
                        a^2b^2 \right) \\
