...
\begin{align}
  ...
  \left<x f(x|\alpha,\beta;t) | u_0(x|\alpha,\beta;t) \right> &= \int_\Omega \frac{x f(x|\alpha,\beta;t)^2}{\| f(x|\alpha,\beta;t) \|} = \frac{1}{\| f(x|\alpha,\beta;t) \|} \int_\Omega \frac{1}{B(\alpha,\beta)} x^\alpha(1-x)^{\beta-1} dx \\
                           &= \frac{1}{\| f(x|\alpha,\beta;t) \|} \frac{B(\alpha+1,\beta)}{B(\alpha,\beta)} = \sqrt{\frac{B(\alpha,\beta)^2}{B(2\alpha-1, 2\beta-1)}}\frac{B(\alpha+1,\beta)}{B(\alpha,\beta)} \\
