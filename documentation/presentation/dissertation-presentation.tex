...
\begin{frame}
  ...
  \begin{frame}
    \centering
  \includegraphics[scale=0.55]{../chapter-2/figures/{limitations-rho-0.95-data-point-4}.pdf}  
  \end{frame}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{ic.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g0.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g0r0.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g1.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g1r1.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g2.pdf}
...
\begin{minipage}{0.3\textwidth}
	...
	\includegraphics[scale=0.4,angle=0]{g3.pdf}
...
\begin{minipage}{5cm}
\begin{center}
\includegraphics[scale=0.5,angle=0]{unmodified-reflection.pdf}
\end{center}
\end{minipage}
&
\begin{minipage}{5cm}
\begin{center}
\includegraphics[scale=0.6,angle=0]{transformed-reflection.pdf}\\
\end{center}
\end{minipage}
\end{tabular}
