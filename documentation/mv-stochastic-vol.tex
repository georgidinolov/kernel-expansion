...
the extreme parameter combinations where $\rho = 0.9$. The solution generated
has properties consisent with those of the analytic $\rho=0$ solution:
conditional on either $\tau_y/\tau_x$ or $\tilde{t}$, the solution
formed, when valid, exibits unimodality and constant concavity around
the mode. 
...
\item To motivate the extension of our numerical method, we consider
  ...
  becomes
    ...
    \begin{align*}
      ...
      A similar analysis can be performed for $\tau_x/\tau_y$
