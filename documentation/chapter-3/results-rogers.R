...
fwrite(x=out, file=paste0("~/PDE-solvers/src/kernel-expansion/documentation/chapter-3/results/mle-results-rho-", rho_data, "-n-", data_size, "/rogers-results.csv"))

out = data.table(sigma_x=sigma_x, sigma_y=sigma_y, rho=rho.classic)
fwrite(x=out, file=paste0("~/PDE-solvers/src/kernel-expansion/documentation/chapter-3/results/mle-results-rho-", rho_data, "-n-", data_size, "/classic-results.csv"))
